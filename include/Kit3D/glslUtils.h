...
extern GLuint loadGeomShaderFile(const std::string& fn,bool log=false);
...
extern GLuint loadGeomShader    (const std::string& str,bool log=false);
...
inline GLuint loadGeomShader    (const std::string& str,bool log)
{
	int len = (int)str.length();
	const char* ptr = str.c_str();
...
inline GLuint loadGeomShaderFile(const std::string& fn,bool log)
{
	std::string str = __loadTextFile(fn);
	return loadGeomShader(str.c_str(),log);
}
